            ...
            <ProductDetailsWrapper>
              ...
              <ProductSizeWrapper>
                <div className="prod-size-top flex items-center flex-wrap">
                  ...
                  <Link to={`/shop/${shopId}`} className="text-sm text-gray-700 font-thin">
                    Ghé Thăm Cửa Hàng <i className="bi bi-arrow-right"></i>
                  </Link>
                  <p className="text-sm font-semibold text-outerspace">Mô Tả: {productDetail?.description}</p>
                </div>
              </ProductSizeWrapper>

              <p className="text-sm font-semibold text-outerspace mt-4">
                Số Lượng Sản Phẩm Khả Dụng:
                <span className="text-sm text-gray-700 font-thin"> {productDetail.stock} Sản Phẩm</span>
              </p>
              {productDetail.stock === 0 || productDetail.status === "CLOSED" ? (
