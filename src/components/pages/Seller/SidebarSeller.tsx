...
const SidebarSeller = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 px-12 py-5.5 lg:py-6.5">
        <NavLink to="/" className="flex items-center gap-3 pt-10">
          ...
          <span className="text-title-md font-bold text-bodydark1">SOUVI</span>
        </NavLink>
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM8 7h8v2H8V7zm0 4h8v2H8v-2z" />
                  </svg>
                  Product
                </NavLink>
              </li>
