        ...
        <div className="w-1/2 h-full bg-[#fff] flex flex-col p-20 justify-between items-center">
          ...
          <div className="w-full flex flex-col max-w-[550px]">
            <div className="w-full flex flex-col mb-2">
              ...
              <p className="text-base mb-2">Chào mừng bạn đến với Souvi !! Vui lòng điền thông tin để đăng kí.</p>
            </div>
            {message != "Successfully Register" ? (
              <div className="text-red-500 text-lg">{message}</div>
            ) : (
              <div className="text-green-500 text-lg">Vui lòng kiểm tra email của bạn để xác minh tài khoản</div>
            )}
          ...
          <div className="w-full flex items-center justify-center">
            <p className="text-sm font-normal text-black">
              Bạn đã có tài khoản ?{" "}
              <Link to="/register">
                <span className="font-semibold underline underline-offset-2 cursor-pointer">Đăng nhập tại đây ?</span>
              </Link>
            </p>
          </div>
        </div>
