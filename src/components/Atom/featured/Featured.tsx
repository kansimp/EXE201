...
import feature1 from '@images/ft.jpg';
import feature2 from '@images/ft2.jpg';
...
export const featuredData: FeaturedItem[] = [
    {
        id: 'featured-1',
        topText: 'Featured Item 1',
        largeText: 'Amazing Product',
        bottomText: 'Description of item 1',
    ...
    {
        id: 'featured-2',
        topText: 'Featured Item 2',
        largeText: 'Awesome Product',
        bottomText: 'Description of item 2',
                    ...
                    {featuredData.map((featured) => (
                        <FeaturedCardWrapper className="text-white" key={featured.id}>
                            ...
                            <div className="feat-card-content w-full h-full">
                                ...
                                <Link to={featured.buttonLink} className="feat-link font-extrabold text-white text-3xl">
                                    {featured.buttonText}
                                </Link>
                            </div>
                        </FeaturedCardWrapper>
